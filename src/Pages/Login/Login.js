...
const Login = () => {
  ...
  return (
    <div className="container flex h-screen justify-center items-center">
      <div className="card w-96 shadow-xl bg-transparent border">
        <div className="card-body">
          ...
          <button
            ...
            className="btn border-white bg-transparent hover:bg-gradient-to-tr from-primary to secondary"
          >
